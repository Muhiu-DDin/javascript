...
var producthtml = document.querySelector(".product");
var numhtml = document.querySelector(".num");
var headinghtml = document.querySelector(".heading");
const allProduct = [
    {
      id: 1,
...
btn.forEach(
  (buttons)=>{
    buttons.addEventListener("click" , 
      ()=>{
        numhtml.innerHTML = String(parseInt(numhtml.innerHTML)+1).padStart(2 , "0");
        headinghtml.classList.remove("hide");
      }
    )
  }
)
